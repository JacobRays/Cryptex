...
class SellUSDTPage extends StatelessWidget {
  const SellUSDTPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final TextEditingController amountCtl = TextEditingController(text: '50');
    return Padding(
      padding: const EdgeInsets.all(16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          NeonText(text: "Sell USDT", fontSize: 22),
